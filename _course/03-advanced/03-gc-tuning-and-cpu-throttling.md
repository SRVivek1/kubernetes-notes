---
layout: lesson
title: "GC Tuning and CPU Throttling in Containers"
seo_title: "JVM GC Tuning vs CPU Throttling in Kubernetes Explained"
...
permalink: /course/advanced/gc-tuning-and-cpu-throttling/
level: advanced
module: 3
lesson: 3
order: 303
...
keywords: [jvm gc tuning kubernetes, g1gc zgc shenandoah, cfs throttling, cpu.stat nr_throttled, gc pause tuning, activeprocessorcount, container cpu limits]
tags: [jvm, gc, cpu-throttling, cgroups, spring-boot]
...
> **Prerequisites:** Complete [Heap Dumps and Memory Leak Hunting](/course/advanced/heap-dumps-and-memory-leaks/) first, so you've already ruled out "the heap is just genuinely full of live leaked objects" before investigating GC tuning or throttling.
