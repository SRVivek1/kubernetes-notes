---
layout: lesson
title: "Low-Level Networking: CNI and kube-proxy Internals"
seo_title: "Kubernetes kube-proxy, CNI & Packet-Level Debugging Guide"
...
permalink: /course/advanced/low-level-networking-cni-and-kube-proxy/
level: advanced
module: 3
lesson: 6
order: 306
...
keywords: [kube-proxy iptables, kubernetes ipvs, cni plugin troubleshooting, calico cilium debugging, tcpdump kubernetes, packet capture pod networking, cilium monitor drop]
tags: [networking, cni, kube-proxy, tcpdump, cilium, calico]
...
> **Prerequisites:** Complete [CPU Profiling with async-profiler](/course/advanced/cpu-profiling-with-async-profiler/) first, and make sure you're already comfortable with the Intermediate-level DNS/Service/NetworkPolicy layered checklist (`/course/intermediate/dns-and-service-discovery-deep-dive/` or equivalent) — this lesson assumes you've already ruled out the higher layers.
