---
layout: lesson
title: "Heap Dumps and Memory Leak Hunting"
seo_title: "Java Heap Dump Analysis in Kubernetes: Find Memory Leaks Fast"
...
permalink: /course/advanced/heap-dumps-and-memory-leaks/
level: advanced
module: 3
lesson: 2
order: 302
...
keywords: [java heap dump kubernetes, memory leak diagnosis, eclipse mat, visualvm, heapdumponoutofmemoryerror, oom investigation, dominator tree]
tags: [jvm, heap, memory-leak, diagnostics, spring-boot]
...
> **Prerequisites:** Complete [Thread Dumps and Deadlock Analysis](/course/advanced/thread-dumps-and-deadlock-analysis/) first — this lesson assumes you're comfortable with `jcmd` and pulling files out of pods with `kubectl cp`.
