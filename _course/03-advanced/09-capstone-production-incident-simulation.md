---
layout: lesson
title: "Capstone: Production Incident Simulation"
seo_title: "Kubernetes Capstone: Simulate a Production Java Incident"
...
permalink: /course/advanced/capstone-production-incident-simulation/
level: advanced
module: 3
lesson: 9
order: 309
...
keywords: [kubernetes incident simulation, root cause analysis java, spring boot chaos testing, production incident report, capstone project kubernetes]
tags: [capstone, incident-response, root-cause-analysis, spring-boot]
...
- [ ] I can articulate, for each incident, what dashboard panel or alert would have caught it earlier — this is the mindset the [Expert level](/course/expert/incident-command-and-postmortems/) builds on next.
