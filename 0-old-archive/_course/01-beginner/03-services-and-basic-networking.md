---
layout: lesson
title: "Services and Basic Networking"
seo_title: "Kubernetes Services & DNS Service Discovery Explained"
...
permalink: /course/beginner/services-and-basic-networking/
level: beginner
module: 1
lesson: 3
order: 103
...
keywords: [kubernetes service, clusterip, nodeport, loadbalancer, dns service discovery, coredns, spring boot microservices]
tags: [services, networking, dns, kubectl]
...
> **Prerequisites:** [Kubernetes Architecture Fundamentals](/course/beginner/kubernetes-architecture-fundamentals/), [Pods, ReplicaSets, and Deployments](/course/beginner/pods-replicasets-and-deployments/)
...
If a Pod fails its readiness probe, it's removed from Endpoints immediately — traffic stops routing to it — without the Pod being deleted. This is the mechanism [Intermediate](/course/intermediate/liveness-readiness-and-startup-probes/) covers in depth.
...
Deeper networking failures — NetworkPolicy rules silently blocking traffic, CNI plugin (Calico/Cilium/Flannel) issues, kube-proxy/iptables debugging, packet captures — are covered in [Intermediate](/course/intermediate/dns-and-service-discovery-deep-dive/), once you've got the basics solid.
