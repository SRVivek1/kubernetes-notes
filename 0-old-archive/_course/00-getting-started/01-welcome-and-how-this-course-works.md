...
seo_title: "Kubernetes Troubleshooting Course for Java Developers | Beginner to Expert"
...
permalink: /course/getting-started/welcome/
level: getting-started
module: 0
lesson: 1
order: 1
prerequisites: []
keywords: [kubernetes course, java kubernetes, spring boot kubernetes, kubernetes troubleshooting, kubernetes for developers]
...
No prior Kubernetes operational experience is assumed. Docker familiarity and comfortable Java/Spring Boot development are the only prerequisites — see [Prerequisites](02-prerequisites.md) for the full checklist.
...
Standalone reference material — the command cheat sheet, incident runbook template, lab-fault-injection ideas, and the full assessment rubric — lives in the [Reference](/reference/) section, separate from the teaching path, so you can jump straight to it once you're operating day-to-day.
...
- [ ] I'm ready to check the [Prerequisites](02-prerequisites.md) page before starting Level 1.
