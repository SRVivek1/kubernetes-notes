...
heading: "Chaos Engineering and Failure Injection"
title: "Kubernetes Chaos Engineering: Chaos Mesh & Litmus Guide"
subtitles:
  - "Use Chaos Mesh and Litmus to inject pod kills, network latency, and CPU stress into Kubernetes, validating alerts and probes before a real incident hits."
permalink: /kubernetes/chaos-engineering-and-failure-injection
seo:
  type: TechArticle
...
| The chaos experiment surfaced a real incident-response gap | [Incident Command and Postmortems](/kubernetes/incident-command-and-postmortems) |
