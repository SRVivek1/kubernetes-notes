...
heading: "Persistent Storage for Stateful Workloads"
title: "Kubernetes PV, PVC & StatefulSets for Spring Boot Apps"
subtitles:
  - "Diagnose Kubernetes PersistentVolume, PVC, and StorageClass issues, RWO vs RWX access modes, and StatefulSet mount failures for stateful Spring Boot workloads."
permalink: /kubernetes/persistent-storage-for-stateful-workloads
seo:
  type: TechArticle
...
This lesson assumes you've completed [ConfigMap and Secret Propagation](/kubernetes/configmap-secret-propagation). No prior storage-specific knowledge is assumed beyond the general pod/Deployment model from Beginner.
{% endcapture %}
