...
heading: "DNS and Service Discovery Deep Dive"
title: "Kubernetes CoreDNS, NetworkPolicy & Java DNS Caching"
subtitles:
  - "Debug CoreDNS architecture, NetworkPolicy traffic blocks, and JVM DNS caching pitfalls including ndots latency for Java microservices on Kubernetes."
permalink: /kubernetes/dns-and-service-discovery-deep-dive
seo:
  type: TechArticle
...
This lesson assumes you've completed [Restart Troubleshooting Across a Deployment](/kubernetes/restart-troubleshooting-across-a-deployment) and already know the basic Service/DNS discovery model and the layered checklist (pod → CoreDNS → Service → Endpoints → pod IP) from [Services and Basic Networking](/kubernetes/services-and-basic-networking) in Beginner.
{% endcapture %}
