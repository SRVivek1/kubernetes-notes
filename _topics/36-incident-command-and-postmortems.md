...
heading: "Incident Command and Postmortems"
title: "Kubernetes Incident Command: Severity, Postmortems, Scale"
subtitles:
  - "Lead Kubernetes incidents with clear severity classification, communication cadence, and blameless postmortems, plus multi-cluster scale considerations."
permalink: /kubernetes/incident-command-and-postmortems
seo:
  type: TechArticle
...
This builds on [Chaos Engineering and Failure Injection](/kubernetes/chaos-engineering-and-failure-injection) and, implicitly, on every diagnostic skill from all four levels of this course, this lesson is about the process wrapped around diagnosis, not a replacement for it.
{% endcapture %}
