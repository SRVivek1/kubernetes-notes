...
heading: "ConfigMaps and Secrets Basics"
title: "Kubernetes ConfigMaps & Secrets for Spring Boot Config"
subtitles:
  - "Externalize Spring Boot application.yml and environment config using Kubernetes ConfigMaps and Secrets, env vars vs volume mounts fully explained."
permalink: /kubernetes/configmaps-and-secrets-basics
seo:
  type: TechArticle
...
[Kubernetes Architecture Fundamentals](/kubernetes/kubernetes-architecture-fundamentals), [Pods, ReplicaSets, and Deployments](/kubernetes/pods-replicasets-and-deployments), [Services and Basic Networking](/kubernetes/services-and-basic-networking)
{% endcapture %}
