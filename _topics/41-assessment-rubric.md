...
heading: "Assessment Rubric & Certification Checklist"
title: "Kubernetes Troubleshooting Assessment Rubric & Checklist"
subtitles:
...
permalink: /kubernetes/assessment-rubric
seo:
  type: TechArticle
...
## Incident process
- [ ] Produces a complete [runbook doc](/kubernetes/incident-runbook-template) under time pressure
...
**Related:** [Incident Runbook Template](/kubernetes/incident-runbook-template) · [Hands-on Lab Ideas](/kubernetes/hands-on-lab-ideas) · [Expert level](/kubernetes/node-and-control-plane-internals)
