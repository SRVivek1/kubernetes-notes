...
heading: "Capstone: Fix a Broken Deployment"
title: "Kubernetes Capstone: Debug a Broken Spring Boot Deployment"
subtitles:
  - "Hands-on Kubernetes capstone: diagnose and fix a broken Spring Boot Deployment, bad image, missing ConfigMap key, no resource limits, using only kubectl."
permalink: /kubernetes/capstone-fix-a-broken-deployment
seo:
  type: TechArticle
...
All previous Beginner lessons, [Kubernetes Architecture Fundamentals](/kubernetes/kubernetes-architecture-fundamentals) through [Image Pull and Scheduling Basics](/kubernetes/image-pull-and-scheduling-basics). If any of the commands below feel unfamiliar, go back to the relevant lesson before continuing.
{% endcapture %}
...
Remember from [ConfigMaps and Secrets Basics](/kubernetes/configmaps-and-secrets-basics): since `DB_URL` is consumed as an env var, updating the ConfigMap alone isn't enough, the rollout restart is required to pick it up.
