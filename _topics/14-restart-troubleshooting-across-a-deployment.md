...
heading: "Restart Troubleshooting Across a Deployment"
title: "Kubernetes Pod Restarts Across a Deployment & Cluster"
subtitles:
  - "Scope Kubernetes pod restarts across a Deployment, namespace, or entire cluster, and track restart trends over time with Prometheus and event history."
permalink: /kubernetes/restart-troubleshooting-across-a-deployment
seo:
  type: TechArticle
...
This lesson assumes you've completed [CrashLoopBackOff and Exit Code Deep Dive](/kubernetes/crashloopbackoff-and-exit-codes), you should already be comfortable diagnosing a single pod's restart reason before scaling that skill up to a whole Deployment or cluster.
{% endcapture %}
