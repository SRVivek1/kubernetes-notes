...
heading: "Resource Requests and Limits Basics"
title: "Kubernetes Resource Requests & Limits for Java Apps"
subtitles:
  - "Understand why Kubernetes CPU and memory requests and limits matter for Spring Boot apps, and how a limit set too low causes OOMKilled pods."
permalink: /kubernetes/resource-requests-and-limits-basics
seo:
  type: TechArticle
...
[Kubernetes Architecture Fundamentals](/kubernetes/kubernetes-architecture-fundamentals), [Pods, ReplicaSets, and Deployments](/kubernetes/pods-replicasets-and-deployments), [Services and Basic Networking](/kubernetes/services-and-basic-networking), [ConfigMaps and Secrets Basics](/kubernetes/configmaps-and-secrets-basics), [Reading Pod Status and Logs](/kubernetes/reading-pod-status-and-logs)
{% endcapture %}
